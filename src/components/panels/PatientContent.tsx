/**
 * Patient card content: read-only info about the loaded study on top, then the
 * editable patient fields that appear in the PDF report. Rendered in the left
 * rail's inner column (above the study/series tree).
 */
