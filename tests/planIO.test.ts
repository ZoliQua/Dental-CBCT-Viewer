...
const sample: PlanData = {
  ...
  guide: { wallMm: 1.5, baseWidthMm: 5, baseHeightMm: 4, channelTolMm: 0.1, segments: 48, sleeveSeat: false, seatClearanceMm: 0.05, sleeveWallMm: 0.9 },
...
describe('planFromObject validation', () => {
  ...
  it('fills defaults for a minimal/partial file', () => {
    ...
    expect(r.guide).toEqual({ wallMm: 1.5, baseWidthMm: 5, baseHeightMm: 4, channelTolMm: 0.1, segments: 48, sleeveSeat: false, seatClearanceMm: 0.05, sleeveWallMm: 0.9 });
